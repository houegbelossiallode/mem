 ...
 */
final class Version20240422130814 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE depense_vivre ADD date DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE depense_vivre DROP date');
    }
}
